                ...
                openP ? (
                    <div className="flex min-h-screen  bg-[var(--white)]">
                        ...
                        <div className="flex-1 relative">
                            ...
                            <div className='pt-30 md:px-30 px-5'>
                                <h1 className='text-center text-2xl font-medium'>Forget Password</h1>
                                <p className='text-md font-medium text-[#666666] md-3 text-center'>Enter the email address associated with your account</p>
                                ...
                                <form className="mt-5">
                                    <fieldset>
                                        ...
                                        <div className='w-full block mt-5'>
                                            <button type="submit" className='w-full px-4 cursor-pointer py-2 bg-[var(--red-primary)] rounded text-[var(--white)]'>Send</button>
                                        </div>
                                    </fieldset>
                                </form>
                            </div>
                    ...
                    <div className='flex flex-col min-h-screen bg-[var(--white)] p-10'>
                        <a href="/">    
                            <Logo width="200px" height="50px" />
                        </a>
                        <div className='flex flex-col h-full w-full m-auto items-center justify-center'>
                           <img src={Mark} alt="Mark" className=' object-cover' />
                           <p className='text-center text-md font-light'>We emailed a link to you. Please click on the link <br /> for account verification</p> 
                        </div>
                    </div>
                )
            }
