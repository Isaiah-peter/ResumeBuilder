    ...
    return (
        <div className="flex min-h-screen  bg-[var(--white)]">
            ...
            <div className="flex-1 relative">
                ...
                <div className=" md:px-20 px-5 m-auto h-full flex">
                    {!otp ? (
                        ...
                        <div className='flex flex-col items-center justify-center'>
                            <h2 className='text-center lg:text-3xl text-2xl font-bold mb-4'>Enter confirmation code</h2>
                            <p className='text-center text-[#666666] mb-4'>We emailed you a code. Please input the code here for account verification</p>
                            <OTPInput length={4} onComplete={() => console.log("hello")} />
                        </div>
                    ) }
                </div>
            </div>
