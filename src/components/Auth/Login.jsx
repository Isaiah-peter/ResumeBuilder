                ...
                <div className="pt-20 md:px-20 px-5">
                    ...
                    <form className="mt-5">
                        <fieldset>
                            ...
                            <a href='/' className='text-end w-full block mt-2 text-blue-500'>forget password?</a>

                            <div className='w-full block mt-5'>
                                <button type="submit" className='w-full px-4 cursor-pointer py-2 bg-[var(--red-primary)] rounded text-[var(--white)]'>Log in</button>
                            </div>
                        </fieldset>
                    </form>
                    ...
                    <a className='flex items-center justify-center rounded mt-4 text-md font-normal text-[var(--black)] border border-gray-300 p-3' href="/">
                        ...
                        <span className='ml-2 text-md font-normal'>Sign in with Google</span>
                    </a>
                    <a className='flex items-center justify-center rounded mt-4 text-md font-normal text-[var(--black)] border border-gray-300 p-3' href="/">
                        <img src={Github} alt="github" className='w-6 h-6' />
                        <span className='ml-2 text-md font-normal'>Sign in with Github</span>
                    </a>
                </div>
            </div>
        </div>
